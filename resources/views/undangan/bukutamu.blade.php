                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="kirimtamu">
                                                                ...
                                                                <a href="https://selaksadigital.com/wedding/{{ $order ? $order->domain : '' }}?to="
                                                                    target="_BLANK" id="tautan" style="font-weight: 700">
                                                                    https://selaksadigital.com/wedding/{{ $order ? $order->domain : '' }}?to=
                                                                </a>
                                                            </div>
        ...
        const copyPesan = (kodetamu, nama, group) => {
            ...
            const pesanLinkUndangan = text
                ...
                .replace(/{link_undangan}/g,
                    'https://selaksadigital.com/wedding/{{ $order ? $order->domain : '' }}' +
                    nama);
